...
public class MvcConfiguration extends WebMvcConfigurerAdapter {  
     ...
     */
	  ...
	  public void addViewControllers(ViewControllerRegistry registry){  
		  //registry.addViewController("/indexController/upLoad").setViewName("wangpan/upload"); 
	  }  
	 ...
	 //这里是自定义映射自己的静态资源目录的  
      ...
      public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		//registry.addResourceHandler("/upload/product/**").addResourceLocations("classpath:/static/img/");
		   ...
		   * 都不对
		   */
		registry.addResourceHandler("/upload/temp/**").addResourceLocations("/upload/temp/");
